                    ...
                    <form method="post">
                        <div class="mb-3">
                            ...
                            <input type="hidden" class="form-control" id="exampleInputEmail1"
                                ...
                                name="itemId" value="<?php echo $row[0]["production_id"]; ?>" disabled />

                            <label for="exampleInputEmail1" class="form-label">Nama Sepatu</label>
                            <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"
                                placeholder="Masukkan Nama Sepatu" autocomplete="off" name="itemName" disabled
                        ...
                        <div class="mb-3">
                            <div class="form-floating">
                                <textarea class="form-control" placeholder="Detail Barang" id="floatingTextarea"
                                    disabled name="detail"><?php echo $row[0]["production_detail"]; ?></textarea>
