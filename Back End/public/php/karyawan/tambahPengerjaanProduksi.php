          ...
          <div class="div-forms p-5">
            <form method="post">
              <div class="mb-3">
                ...
                <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Masukkan Nama Sepatu" autocomplete="off" name="" />
              </div>
              ...
              <div class="mb-3">
                ...
                <input type="date" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="" autocomplete="off" disabled name="" />
              </div>
              <div class="mb-3">
